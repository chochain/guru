...
__GURU__ void 	vm_state_push(guru_vm *vm, guru_irep *irep, GV *regs, U32 argc);
__GURU__ void	vm_state_pop(guru_vm *vm, GV ret_val, U32 ra);
...
__GURU__ U32	vm_method_exec(guru_vm *vm, GV v[], U32 argc, guru_proc *prc);
